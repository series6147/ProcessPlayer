...
namespace ProcessPlayer.Data.Common
{
    public static class TypeExtensions
    {
        ...
        public static bool IsComplex(this object value)
        {
            return value == null ? false : value.GetType().IsComplex();
        }

        public static bool IsComplex(this Type type)
        {
            return !type.IsSubclassOf(typeof(ValueType)) && !type.Equals(typeof(string));
        }
        ...
        public static T ToValue<T>(this object value)
        {
            try
            {
                return value == null || value == DBNull.Value || value == DependencyProperty.UnsetValue
                    ? default(T)
                    : value is T
                        ? (T)value
